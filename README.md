...
(2) Objective
To develop and compare machine learning classifiers (Naïve Bayes, Logistic Regression, and SVM) that can automatically categorize the sentiment of FIFA World Cup 2022 tweets based on their text content.
...
Model Building: Used TF-IDF Vectorization (unigrams and bigrams). Implemented three models: Multinomial Naïve Bayes, Logistic Regression (balanced), and Linear SVM (balanced).
...
Naïve Bayes: ~50% Accuracy. Best at recalling Positive tweets but struggled with minority classes.
...
(6) How to Run
Ensure the dataset is placed at /content/fifa_world_cup_2022_tweets.csv.
Install dependencies:
pip install pandas numpy scikit-learn matplotlib seaborn
Run the notebook cells sequentially to train models and generate visualizations.
(7) Conclusion
